...
@Controller('cart')
@ApiTags('cart')
export class CartController extends BaseController<CartService, CartDto> {
  constructor(readonly _service: CartService) {
    super(_service);
  }
  ...
  //   description: 'Create',
  // })
  // async create(@Body() params: CreateCartDto) {
  ...
  async update(@UUIDParam('id') id: string, @Body() params: CartDto) {
